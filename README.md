...
- SoC family: `rockchip-rk3568`
- U-Boot config: `evb-rk3568_defconfig`
...
- If the image builds but does not boot, try changing `BOOTCONFIG` in `config/rk3568-ydtx-kvm.csc` to a closer RK3568 board U-Boot defconfig.
